...
Namespace XPOInstant.SL
    Public Class XPOInstantModeCRUDBehavior
        ...
        Public Shared ReadOnly NewRowFormProperty As DependencyProperty = DependencyProperty.Register("NewRowForm", GetType(DataTemplate), GetType(XPOInstantModeCRUDBehavior), New PropertyMetadata(Nothing))
        Public Shared ReadOnly EditRowFormProperty As DependencyProperty = DependencyProperty.Register("EditRowForm", GetType(DataTemplate), GetType(XPOInstantModeCRUDBehavior), New PropertyMetadata(Nothing))
        Public Shared ReadOnly XPObjectTypeProperty As DependencyProperty = DependencyProperty.Register("XPObjectType", GetType(Type), GetType(XPOInstantModeCRUDBehavior), New PropertyMetadata(Nothing))
        Public Shared ReadOnly CollectionSourceProperty As DependencyProperty = DependencyProperty.Register("CollectionSource", GetType(XPInstantFeedbackSource), GetType(XPOInstantModeCRUDBehavior), New PropertyMetadata(Nothing))
        Public Shared ReadOnly AllowKeyDownActionsProperty As DependencyProperty = DependencyProperty.Register("AllowKeyDownActions", GetType(Boolean), GetType(XPOInstantModeCRUDBehavior), New PropertyMetadata(False))
        Public Shared ReadOnly PrimaryKeyProperty As DependencyProperty = DependencyProperty.Register("PrimaryKey", GetType(String), GetType(XPOInstantModeCRUDBehavior), New PropertyMetadata(String.Empty))
        Public Shared ReadOnly ServiceHelperProperty As DependencyProperty = DependencyProperty.Register("ServiceHelper", GetType(IServiceHelper), GetType(XPOInstantModeCRUDBehavior), New PropertyMetadata(Nothing))
        ...
        Private Sub Uninitialize()
            ...
            RemoveHandler Grid.CurrentItemChanged, AddressOf Grid_CurrentItemChanged
        End Sub
    End Class
