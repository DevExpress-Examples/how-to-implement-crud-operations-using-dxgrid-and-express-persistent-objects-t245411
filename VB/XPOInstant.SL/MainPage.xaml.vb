...
Namespace XPOInstant.SL
    Partial Public Class MainPage
        ...
        Public Shared ReadOnly CollectionProperty As DependencyProperty = DependencyProperty.Register("Collection", GetType(XPInstantFeedbackSource), GetType(MainPage), New PropertyMetadata(Nothing))
