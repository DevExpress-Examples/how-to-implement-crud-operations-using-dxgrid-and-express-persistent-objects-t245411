...
namespace XPOInstant.SL {
    public class XPOInstantModeCRUDBehavior: Behavior<GridControl> {
        public static readonly DependencyProperty NewRowFormProperty =
            DependencyProperty.Register("NewRowForm", typeof(DataTemplate), typeof(XPOInstantModeCRUDBehavior), new PropertyMetadata(null));
        public static readonly DependencyProperty EditRowFormProperty =
            DependencyProperty.Register("EditRowForm", typeof(DataTemplate), typeof(XPOInstantModeCRUDBehavior), new PropertyMetadata(null));
        public static readonly DependencyProperty XPObjectTypeProperty =
            DependencyProperty.Register("XPObjectType", typeof(Type), typeof(XPOInstantModeCRUDBehavior), new PropertyMetadata(null));
        public static readonly DependencyProperty CollectionSourceProperty =
            DependencyProperty.Register("CollectionSource", typeof(XPInstantFeedbackSource), typeof(XPOInstantModeCRUDBehavior), new PropertyMetadata(null));
        public static readonly DependencyProperty AllowKeyDownActionsProperty =
            DependencyProperty.Register("AllowKeyDownActions", typeof(bool), typeof(XPOInstantModeCRUDBehavior), new PropertyMetadata(false));
        public static readonly DependencyProperty PrimaryKeyProperty =
            DependencyProperty.Register("PrimaryKey", typeof(string), typeof(XPOInstantModeCRUDBehavior), new PropertyMetadata(string.Empty));
        public static readonly DependencyProperty ServiceHelperProperty =
            DependencyProperty.Register("ServiceHelper", typeof(IServiceHelper), typeof(XPOInstantModeCRUDBehavior), new PropertyMetadata(null));
